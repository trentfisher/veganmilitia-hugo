...
NOTE: I started writing this on 22-Jul-2004, tranferred it to my personal wiki on 15-Oct-2006 and the last edit was on 4-Feb-2011.
...
Clearly, even the slightest increase in latency between these hosts will mean a huge performance degradation.  According to [http://www.stuartcheshire.org/rants/Latency.html It's the Latency, Stupid] the theoretical minimum latency for between machines on opposite shores of the USA is 42ms, in Siebel it seems to be about 62ms... that translates to a '''minimum''' checkin time of 62 seconds and that does not account for any processing time on any of the involved machines.
...
* Use the version of perl shipped with ClearCase is ancient and has no libraries.  (Update: 7.0 seems to have fixed this)
